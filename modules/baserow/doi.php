...
add_action(
	'doihelper_init',
	'wpcf7_baserow_doi_register_agent',
	10, 0
);

/**
 * Registers wpcf7_baserow as an agent.
 */
function wpcf7_baserow_doi_register_agent() {
	if ( ! function_exists( 'doihelper_register_agent' ) ) {
		return;
	}

	doihelper_register_agent( 'wpcf7_baserow', array(
		'optin_callback' => apply_filters(
			'wpcf7_baserow_doi_optin_callback',
			'wpcf7_baserow_doi_default_optin_callback'
		),
		'email_callback' => apply_filters(
			'wpcf7_baserow_doi_email_callback',
			'wpcf7_baserow_doi_default_email_callback'
		),
	) );
}
 ...
 */
function wpcf7_baserow_doi_default_optin_callback( $properties ) {
 ...
 */
function wpcf7_baserow_doi_default_email_callback( $args ) {
