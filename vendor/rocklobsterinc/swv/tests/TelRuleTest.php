...
final class TelRuleTest extends TestCase
{
    public static string $ruleClass = "\RockLobsterInc\Swv\Rules\TelRule";
    ...
    public static function validValueProvider(): array
    {
        return [
            "blank" => [""],
            "valid" => ["1234567"],
            "country-coded" => ["+81 1234567"],
            "with-extension" => ["1234567#abcdef"],
        ];
    }
