...
final class MinDateRuleTest extends TestCase
{
    public static string $ruleClass = "\RockLobsterInc\Swv\Rules\MinDateRule";

    public static function validValueProvider(): array
    {
        return [
            "blank" => ["", "2026-07-28"],
            "non-date" => ["xxx", "2026-07-28"],
            "valid" => ["2026-07-28", "2026-07-28"],
        ];
    }
