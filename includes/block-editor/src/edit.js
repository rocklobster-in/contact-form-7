...
export default function ContactFormSelectorEdit({ attributes, setAttributes }) {
  ...
  const [contactForms, setContactForms] = useState(() => createMap([]));
        ...
        {attributes.id && (
          ...
          >
            <TextControl
              ...
              help={__(
                "Used for the id attribute value of the form element.",
                "contact-form-7",
              )}
            />
            <TextControl
              ...
              help={__(
                "Used for the name attribute value of the form element.",
                "contact-form-7",
              )}
            />
            <TextControl
              ...
              help={__(
                "Used for the aria-label attribute value of the form element.",
                "contact-form-7",
              )}
            />
            <TextControl
              ...
              help={__(
                "Used for the class attribute value of the form element.",
                "contact-form-7",
              )}
            />
          </PanelBody>
